...
Bygga ett garage ( Consoleapplikation ). 
Denna applikation skall tillhandahålla den funktionalitet som ett 
system kan behöva om det skall användas för att simulera ett enkelt garage. 

Det skall alltså gå att: 
- parkera fordon, 
- hämta ut fordon, 
- kolla upp fordon som finns där och 
- se egenskaper de har. 
...
tas ut ur garaget, samt att vi kan få en presentation av vad som finns i garaget och söka i det. 
...
Olika fordon tar olika stor plats tex en bil tar 1 plats en båt tar 2 platser ett flygplan kräver 3 
